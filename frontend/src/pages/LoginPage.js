...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-page flex items-center justify-center px-4" data-testid="login-page">
      <motion.div
      ...
      >
        ...
        <div className="bg-white border border-border-default rounded-2xl p-8 shadow-sm">
          <h1 className="font-heading text-2xl font-semibold text-text-primary mb-1">Welcome back</h1>
          <p className="text-text-secondary text-sm mb-6">Sign in to your account</p>

          {error && (
            <div className="bg-red-50 border border-red-200 text-red-700 text-sm rounded-xl px-4 py-3 mb-4" data-testid="login-error">
              {error}
            </div>
          )}
        ...
        <p className="text-center text-sm text-text-secondary mt-6">
          ...
          <Link to="/register" className="text-brand hover:underline font-medium" data-testid="register-link">
            Sign up
          </Link>
        </p>
      </motion.div>
